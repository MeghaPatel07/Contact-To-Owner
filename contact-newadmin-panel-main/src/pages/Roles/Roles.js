...
import {
  getRoleDetailsbyParams,getRoles,updateRoles,listRoles,removeRoles,createRoles,uploadproductImage
} from "../../functions/Roles/Roles";
...
const CmsMaster = () => {
  ...
  const handleClick = (e) => {
    e.preventDefault();
    setFormErrors({});
    let errors = validate(rolename, Detail, roleImage);
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    let erros = validate(rolename, Detail, roleImage);
    setFormErrors(erros);
    setIsSubmit(true);
  ...
  const validate = (rolename,Detail,roleImage) => {
    const errors = {};
  ...
  document.title = "Team Member master | Contact to Owner";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          ...
          <BreadCrumb  maintitle="CMS" title="Team Member master"  pageTitle="CMS"/>
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" lg={4} md={6} sm={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Team Member master</h2>
                    </Col>
                    <Col lg={4} md={6} sm={6}>
                      <div
                        style={{
...
className={validClassBD}
      ...
      >
        ...
        >
          ...
          <span style={{ marginRight: "210px" }}>Remove Team Member</span>
