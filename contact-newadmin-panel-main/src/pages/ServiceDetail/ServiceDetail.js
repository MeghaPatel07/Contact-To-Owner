...
const ServiceDetail = () => {
  ...
  const validate = (blogDesc, blogTitle, blogImage,types) => {
    ...
    if (blogTitle === "") {
      errors.blogTitle = "Service Title is required!";
      setErrBT(true);
    }
    if (blogTitle !== "") {
      setErrBT(false);
    ...
    if (blogDesc === "") {
      errors.blogDesc = "Service Description is required!";
      setErrBD(true);
    }
    if (blogDesc !== "") {
      setErrBD(false);
    ...
    if (blogImage === "") {
      errors.blogImage = "Service Image is required!";
      setErrBI(true);
    }
    if (blogImage !== "") {
      setErrBI(false);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb  maintitle="CMS" title="Service Detail" pageTitle="CMS" />
