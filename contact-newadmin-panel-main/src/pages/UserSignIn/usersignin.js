...
import {
    getUsers,updateUsers,listUsers,removeUsers,createUsers
...
const UserSignIn = () => {
  ...
  const { firstName, lastName, email, password, mobile_no, IsActive} =
    values;
...
if (values.mobile_no === "") {
      errors.mobile_no = "Mobile Number should be of 10 digits!!";
      setErrMN(true);
    }
    if (!/^[0-9]{10}$/.test(values.mobile_no)) {
      errors.mobile_no = "Mobile Number should be of 10 digits!!";
      setErrMN(true);
    }
    if (values.mobile_no !== "") {
...
//     errBI && isSubmit ? "form-control is-invalid" : "form-control";
  ...
  document.title = "Registered Users|Contact to Owner" ;

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb  title="Registered Users" pageTitle="Set up" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Registered Users</h2>
                    </Col>
              ...
              {values.bannerImage || photoAdd ? (
                <img
                  ...
                  src={
                    checkImagePhoto
                      ? photoAdd
                      : `${process.env.REACT_APP_API_URL_SCANSSY}/${values.bannerImage}`
                  }
                  width="300"
                  height="200"
                />
