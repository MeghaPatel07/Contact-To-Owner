...
} from "../../functions/CMSContacttoowner/Cms"
const Cms = () => {
        ...
        return loader.file.then((file) => {
          ...
          return uploadproductImageAboutUs(body)
            .then((response) => {
              ...
              return {
                default: `${process.env.REACT_APP_API_URL_CONTACTUS}/uploads/AboutUS/${Url}`,
              };
            })
            .catch((err) => {
...
//   };
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_CONTACTUS}/api/auth/list-by-params/specialitymanagement`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
...
console.log(imageurl);
  ...
  const validClassSP = errSP && isSubmit ? "form-control is-invalid p-0" : "form-control";
...
const handleSubmitCms = async () => {
  ...
  const options = [
    ...
    { value: '661e2abb521bb9cc8ef7a373', label: 'About Us' },
    { value: '663b10a5c0a7dfb636b61a9d', label: 'Terms and condition' },
    { value: '663b112bc0a7dfb636b61a9f', label: 'Home About Us' },
  ...
  <div className="mb-3 form-floating">
    ...
    />{productImage && (
      <img src={productImage} alt="Uploaded" style={{ maxWidth: "100px" }} />
    )}
  ...
  <div className="mb-3 form-floating">
    ...
    />{productImage1 && (
      <img src={productImage1} alt="Uploaded" style={{ maxWidth: "100px" }} />
    )}
